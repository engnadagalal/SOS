...
class DRScheduleTab extends StatefulWidget {
  const DRScheduleTab({Key? key}) : super(key: key);

  @override
  State<DRScheduleTab> createState() => _DRScheduleTabState();
}
...
class _DRScheduleTabState extends State<DRScheduleTab> {
  ...
  void _fetchAppointments() async {
    final QuerySnapshot snapshot = await FirebaseFirestore.instance.collection('Patient.Resv.DR').get();
