...
class _DoctorProfileState extends State<DoctorProfile> {
  ...
  void initState() {
    ...
    _appointmentsController.text = _appointments;
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildTextField('Appointments', _appointmentsController),
  ...
  void _saveChanges() async {
    setState(() {
      ...
      _appointments = _appointmentsController.text;
