...
class DoctorBotPage extends StatefulWidget {
  @override
  _DoctorBotPageState createState() => _DoctorBotPageState();
}

class _DoctorBotPageState extends State<DoctorBotPage> {

 
  TextEditingController _userInput =TextEditingController();

  static const apiKey = "<AIzaSyCgSoE_6FHZP3c_GX0B8RdNH65_rV63vqo>";
