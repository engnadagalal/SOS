...
import 'package:sos_app/tabs/doctor_ScheduleTab.dart';
import 'package:sos_app/tabs/doctor_Profile.dart'; // Import the doctor profile file
...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    List<Widget> screens = [
      ...
      DRScheduleTab(),
      DoctorProfile(), // New profile page added here
    ];
