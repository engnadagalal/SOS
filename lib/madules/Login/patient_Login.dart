...
import '../what_want/who_Want.dart';
            ...
            child: ElevatedButton(
              ...
              onPressed: () async {
                try {
                  ...
                  // After the user is logged in, check if the user is a patient
                  DocumentSnapshot docSnapshot = await _firestore
                      .collection('patients')
                      .doc(userCredential.user!.uid)
                      .get();
                  if (docSnapshot.exists) {
                    // The user is a patient, navigate to the next screen
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                    ...
                    // The user is not a patient, handle accordingly
